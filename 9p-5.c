...
void createMagicSquare(unsigned short magicSquareSize, unsigned short magicSquare[magicSquareSize][magicSquareSize]){
...
void printMagicSquare(unsigned short magicSquareSize, unsigned short magicSquare[magicSquareSize][magicSquareSize]){
    for (unsigned char y = 0; y < magicSquareSize; y++){
        for (unsigned char x = 0; x < magicSquareSize; x++)
            printf("%4hu ", magicSquare[y][x]);
        putchar('\n');
    }
...
int main(void){
    ...
    printf("Enter the size of the square (odd number between 3 & 99) => "); scanf("%hhu", &magicSquareSize);
    ...
    createMagicSquare(magicSquareSize, magicSquare);

    printMagicSquare(magicSquareSize, magicSquare);
